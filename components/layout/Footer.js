          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="position-relative newsletter-inner"></div>
              </div>
            </div>
            ...
            <div className="row mt-50 mb-50">
              <div className="col-xl-8">
                <div className="contact-from-area padding-20-row-col">
                  <h5 className="text-brand mb-10">ติดต่อเรา</h5>
                  <h2 className="mb-10">แจ้งปัญหาการใช้งาน / ติดต่อเรา</h2>
                  <p className="text-muted mb-30 font-sm">
                    เราจะรีบแก้ไขปัญหาที่คุณพบโดยเร็วแน่นอน *
                  </p>
                  <form
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-12 col-md-12">
                        <div className="textarea-style mb-30">
                          <textarea
                            name="message"
                            placeholder="ราละเอียดเพิ่มเติม"
                          ></textarea>
                        </div>
                        <button
